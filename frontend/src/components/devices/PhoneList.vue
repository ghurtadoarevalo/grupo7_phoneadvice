<template>
  <v-container grid-list-xl>
    <v-layout v-if="largo == 1" row wrap style="margin-top:-5%; margin-left:6.5%">
    ...
    <v-layout v-else-if="largo == 2" row wrap style="margin-top:-5%; margin-left:6.5%">
    ...
    <v-layout v-else-if="largo == 3" row wrap style="margin-top:-5%; margin-left:6.5%">
    ...
    <v-layout v-else-if="largo == 4" row wrap style="margin-top:-5%; margin-left:6.5%">
    ...
    <v-layout v-else-if="largo == 5" row wrap style="margin-top:-5%; margin-left:6.5%">
    ...
    <v-layout v-else-if="largo == 6" row wrap style="margin-top:-5%; margin-left:6.5%">
    ...
    <v-layout v-else-if="largo == 7" row wrap style="margin-top:-5%; margin-left:6.5%">
      <v-flex style="margin-left:1.6%;margin-right: 1.6%" xs1 md1 v-for="(img, index) in topTen.topTenImgList" :key="index">
          <v-img height="100%" class="imagen" @click="dialog=true;indice=index" :src="require('@/assets/phones/'+ img + '.png')">
          </v-img>
      </v-flex>
    </v-layout>
    <v-layout v-else-if="largo == 8" row wrap style="margin-top:-5%; margin-left:6.5%">
      <v-flex style="margin-left:1%;margin-right: 1%" xs1 md1 v-for="(img, index) in topTen.topTenImgList" :key="index">
          <v-img height="100%" class="imagen" @click="dialog=true;indice=index" :src="require('@/assets/phones/'+ img + '.png')">
          </v-img>
      </v-flex>
    </v-layout>
    <v-layout v-else-if="largo == 9" row wrap style="margin-top:-5%; margin-left:6.5%">
      <v-flex style="margin-left:0.6%;margin-right: 0.6%" xs1 md1 v-for="(img, index) in topTen.topTenImgList" :key="index">
          <v-img height="100%" class="imagen" @click="dialog=true;indice=index" :src="require('@/assets/phones/'+ img + '.png')">
          </v-img>
      </v-flex>
    </v-layout>
    <v-layout v-else-if="largo == 10" row wrap style="margin-top:-5%; margin-left:6.5%">
      <v-flex style="margin-left:0.3%;margin-right:0.3%" xs1 md1 v-for="(img, index) in topTen.topTenImgList" :key="index">
          <v-img height="100%" class="imagen" @click="dialog=true;indice=index" :src="require('@/assets/phones/'+ img + '.png')">
          </v-img>
      </v-flex>
      <v-flex md1 v-if="imgList.length>1">
        <v-btn @click="dialog2=true" large outline color="#0E318A">
          <VIcon>phone_iphone</VIcon>¡Aún hay más!</v-btn>      
      </v-flex>
    </v-layout>

    <v-dialog lazy v-if="largo > 0" v-model="dialog" width="500">
      <v-card>
    ...
    <v-dialog lazy v-if="imgList.length > 0" v-model="dialog3" width="500">
      <v-card>
        <v-toolbar color="#0E318A" dark>
    ...
    <v-dialog lazy v-if="imgList.length > 0" v-model="dialog2" width="500">
      <v-card>
        <v-toolbar color="#0E318A" dark>
...
import { mapState } from 'vuex';
  export default {
    ...
    watch: {
      ...
      topTen: function(){
        this.largo = this.topTen.topTenImgList.length
      }
    },
  }
</script>
