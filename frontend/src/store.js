...
export default new Vuex.Store({
  state: {
    ...
    listaEquipos: [
      ...
      {id:5,name:'Xiaomi redmi note 7',   evalP:8,  evalN:6,  gama:2,img:'https://www.movilzona.es/app/uploads/2019/01/redmi-note-7-300.png'},
      ...
      {id:8,name:'Samsung Galaxy s10',    evalP:11, evalN:11, gama:1,img:'https://www.att.com/catalog/en/idse/Samsung/Samsung%20Galaxy%20S10/Prism%20Black-hero-zoom.png'}
    ]
  },
  mutations: {
    //Button bar
